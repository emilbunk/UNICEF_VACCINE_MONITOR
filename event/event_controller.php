  ...
  */
  ...
  function event_controller()
  {
    ...
    if ($action == 'add' && $session['write'])
    {
      ...
      $setphonenumber = get('setphonenumber');
      
      event_add($userid,$eventfeed,$eventtype,$eventvalue,$action,$setfeed,$setemail,$setvalue,$callcurl,$message,$mutetime,$priority,$delaytime,$setphonenumber);
